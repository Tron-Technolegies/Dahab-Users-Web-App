    ...
    >
      ...
      <div className="grid grid-cols-2 gap-5 w-full">
        <BenefitCard
          ...
          sub={"Top-tier hosting in Ethiopia with green reliable power"}
        />
        <BenefitCard
          icon={"/page0/icon-9.png"}
          content={"Built-in Mining Pool"}
          sub={
            "No Pool setup needed. The app itself handles everything. Track rewards go straight to your account"
          }
        />
        <BenefitCard
