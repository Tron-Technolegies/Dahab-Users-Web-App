...
export default function HowDoesItWork({ oneA }) {
  return (
    ...
    >
      ...
      <div
        className={`grid lg:grid-cols-3 mt-7 gap-2 z-10 ${
      ...
      >
        <div className="bg-[#041637] rounded-md md:h-[320px] h-[400px] flex flex-col relative">
          ...
          <div className="flex flex-col gap-2 pt-5 px-5">
            <p className="text-[21px]">What Is Bitcoin Mining, Really?</p>
            <p className="text-[#9F9F9F] text-sm">
              Bitcoin mining is the process of using powerful computers to solve
              complex problems that secure the Bitcoin Network. As a reward,
              miners earn newly generated Bitcoin.
            </p>
          </div>

          <div className="overflow-hidden flex items-start justify-end">
            <img src="/page0/noor.png" className=" object-cover md:w-[300px]" />
          </div>
        </div>{" "}
        <div className="lg:col-span-2 bg-[#041637] rounded-md flex justify-between md:h-[320px] h-[400px] relative">
          ...
          <div className="flex flex-col gap-2 p-5">
            ...
            <p className="text-[#9F9F9F] text-sm">
              If you're ever tried mining on your own, you know how exhausting
              it can be:
            </p>
            <p className="text-[#9F9F9F] text-sm ms-2">
              <li>Finding reliable hardware sellers</li>
              <li>Weeks of delivery and customs delay</li>
              <li>Finding a secure location with enough power</li>
              <li>Paying upfront setup, hosting, deposits, and hidden fees</li>
              <li>Dealing With repairs and constant monitoring</li>
            </p>
            <p className="text-[#9F9F9F] text-sm">
              And after all that? You're still in doubt of profitability. No
              wonder most people give up before they even get started.
            </p>
          </div>
        ...
        <div className="lg:col-span-2 bg-[#041637] rounded-md relative md:h-[250px] h-[400px] flex sm:flex-row flex-col">
          ...
          <div className="flex flex-col gap-3 p-5">
            <p className="text-[21px]">Dahab Makes It Easy</p>
            <p className="text-[#9F9F9F] text-sm">
              At Dahab, we've already done all the hard work. The machines are
              live in our data centers. Just a few clicks, and it starts mining
              for you.
            </p>
            <p className="text-[#9F9F9F] text-sm">
          ...
          <div className=" overflow-hidden pt-5 sm:self-end">
            <img src="/page0/rawa.png" className="object-cover  md:w-[320px]" />
          </div>
        </div>
