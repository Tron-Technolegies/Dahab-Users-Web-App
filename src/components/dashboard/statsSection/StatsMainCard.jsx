...
export default function StatsMainCard() {
  ...
  return (
    <div className="p-10  bg-gradient-to-r from-[#0692DC] to-[#59b3e4] lg:w-1/2 rounded-4xl relative flex flex-col gap-3 items-center">
      <p>Daily Earnings</p>
      ...
      <Link className="underline">Detailed View</Link>
    </div>
  );
}
