        ...
        <div className="flex flex-col gap-5">
          ...
          <ul className="font-light ms-10">
            <li>
              ...
              when you purchase a miner, request hosting, or contact us.
            </li>
            <li>
          ...
          <ul className="font-light ms-10">
            ...
            <li>
              Hosting service agreements, including contract duration and
              service terms.
            </li>
            <li>
              Repair requests, including miner specifications, issue reports,
              and warranty claims.
            </li>
          </ul>
          <h4 className="text-2xl font-semibold">
          ...
          <ul className="font-light ms-10">
            <li>
              Process and fulfill orders for mining machines and hosting
              services.
            </li>
          ...
          <ul className="font-light ms-10">
            ...
            <li>
              Hosting in UAE requires a deposit and hosting advance equivalent
              to one month’s hosting fee.
            </li>
          ...
          <ul className="font-light ms-10">
            <li>
              ...
              Third-party vendors assisting in payment processing, delivery, or
              IT support.
            </li>
            <li>
              <span className="font-medium">Legal compliance:</span> When
              required by UAE laws or regulatory authorities.
            </li>
            <li>
